...
class ViewChPage extends StatefulWidget {
  @override
  State<ViewChPage> createState() => _ViewChPageState();
}

class _ViewChPageState extends State<ViewChPage> {
  List<String> docIDs = [];
                      ...
                      child: docIDs.isEmpty
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: ListTile(
                              title: GetCheViewPage(documentId: docIDs[index],),
                            ),
                          );
                        },
                      ),
